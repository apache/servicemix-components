...
/**
 * @org.apache.xbean.XBean element="component" description="XMPP Component"
 */
public class XMPPComponent extends DefaultComponent {
    private XMPPEndpointType[] endpoints;

    /**
     *
     * @return all available endpoint classes
     */
    public XMPPEndpointType[] getEndpoints() {
        return endpoints;
    }
     ...
     */
    public void setEndpoints(XMPPEndpointType[] endpoints) {
    ...
    protected Class[] getEndpointClasses() {
        return new Class[] {XMPPReceiverEndpoint.class, XMPPSenderEndpoint.class};
    }
}
