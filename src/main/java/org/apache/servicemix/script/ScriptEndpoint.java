 ...
 * @author lhein
 */
public class ScriptEndpoint extends ProviderEndpoint implements ScriptEndpointType {
    ...
    public void validate() throws DeploymentException {
        ...
        if (script == null) {
            ...
            this.engine = this.manager.getEngineByExtension(FilenameUtils.getExtension(script.getFilename()));
            if (this.engine == null) {
                throw new DeploymentException("There is no script engine registered for extension "
    ...
    protected void doScripting(MessageExchange exchange) throws Exception {
        ...
        // Unknown role
            ...
            throw new MessagingException("ScriptEndpoint.doScripting(): Unknown role: " + exchange.getRole());
        }
    }
