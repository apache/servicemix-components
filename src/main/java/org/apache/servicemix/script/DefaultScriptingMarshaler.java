...
public class DefaultScriptingMarshaler implements ScriptingMarshalerSupport {
     ...
     */
    public void registerUserBeans(ScriptEndpoint endpoint, MessageExchange exchange, Bindings bindings) {
     ...
     */
    public InputStream getScriptCode(ScriptEndpoint endpoint, MessageExchange exchange) throws IOException {
